...
# with command line options: step3 -s RAW2DIGI,RECO,RECOSIM,PAT,VALIDATION:@phase2Validation+@miniAODValidation,DQM:@phase2+@miniAODDQM --conditions auto:phase2_realistic_T25 --datatier DQMIO -n -1 --eventcontent DQM --geometry Extended2026D98 --era Phase2C17I13M9 --filein file:step2.root --fileout file:step3.root --nThreads 8 --no_exec
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Phase2C17I13M9_cff import Phase2C17I13M9
from Configuration.ProcessModifiers.ticl_v5_cff import *
process = cms.Process('RECO',Phase2C17I13M9, __PROCESS_MODIFIER__)
