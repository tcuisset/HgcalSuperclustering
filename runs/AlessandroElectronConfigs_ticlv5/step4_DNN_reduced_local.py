# FOr DQM harvesting of the output of step3_TICLv5_DNN_reduced

# Auto generated configuration file
# using: 
# Revision: 1.19 
# Source: /local/reps/CMSSW/CMSSW/Configuration/Applications/python/ConfigBuilder.py,v 
# with command line options: step4 -s HARVESTING:@phase2Validation+@phase2 --conditions auto:phase2_realistic_T21 --mc --geometry Extended2026D88 --scenario pp --filetype DQM --era Phase2C17I13M9 --filein file:step3_inDQM.root --fileout file:step4.root --no_exec
...
import glob
process.source = cms.Source("DQMRootSource",
    fileNames = cms.untracked.vstring(*('file:' + file for file in glob.glob("step3_inDQM_*.root")))
)
...
process.schedule = cms.Schedule(process.postValidation_common_step,
    ...
    # process.mtdValidationPostProcessor_step,process.postValidationOuterTracker_step,process.trackerphase2ValidationHarvesting_step,
    process.validationHarvesting,
    #process.DQMHarvestBeam_step,process.DQMHarvestTracking_step,process.DQMHarvestOuterTracker_step,process.DQMHarvestTrackerPhase2_step,process.DQMHarvestMuon_step,process.DQMCertMuon_step,process.DQMHarvestHcal_step,process.DQMHarvestHcal2_step,
    process.DQMHarvestEGamma_step,process.DQMCertEGamma_step,
    #process.DQMHarvestL1TPhase2_step,
    process.HLTMonitoringClient_step,process.dqmsave_step)
