...
# with command line options: step3b -s RECO,RECOSIM,PAT,VALIDATION:@phase2Validation,DQM:@phase2 --conditions auto:phase2_realistic_T25 --datatier GEN-SIM-RECO,DQMIO -n 100 --eventcontent FEVTDEBUGHLT,DQM --geometry Extended2026D101 --era Phase2C17I13M9 --filein file:step3.root --fileout file:step3b.root --nThreads 20 --no_exec
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Phase2C17I13M9_cff import Phase2C17I13M9

process = cms.Process('RECOticl',Phase2C17I13M9)
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step3b.root'),
...
process.DQMoutput = cms.OutputModule("DQMRootOutputModule",
    ...
    fileName = cms.untracked.string('file:step3b_inDQM.root'),
