...
# Schedule definition
from RecoHGCal.TICL.customiseForTICLv5_cff import customiseForTICLv5; process = customiseForTICLv5(process, True)
...
process.source.fileNames = cms.untracked.vstring('file:/grid_mnt/data_cms_upgrade/cuisset/supercls/diffEgamma/v1-0cd616/step2_1.root')
...
process.Timing = cms.Service("Timing",
  ...
  excessiveTimeThreshold = cms.untracked.double(5.),
)