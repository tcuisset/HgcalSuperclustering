...
# with command line options: step3 -s RAW2DIGI,RECO,RECOSIM,PAT,VALIDATION:@phase2Validation,DQM:@phase2 --conditions auto:phase2_realistic_T33 --datatier GEN-SIM-RECO,DQMIO -n -1 --eventcontent FEVTDEBUGHLT,DQM --geometry Extended2026D110 --era Phase2C17I13M9 --procModifiers ticl_v5 --filein file:step2.root --fileout file:step3.root --nThreads 8 --no_exec
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Phase2C17I13M9_cff import Phase2C17I13M9
from Configuration.ProcessModifiers.ticl_v5_cff import ticl_v5, ticl_v5_superclustering_dnn

process = cms.Process('RECO',Phase2C17I13M9,ticl_v5,ticl_v5_superclustering_dnn)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step3 mustache_dumper_forReReco nevts:-1'),
