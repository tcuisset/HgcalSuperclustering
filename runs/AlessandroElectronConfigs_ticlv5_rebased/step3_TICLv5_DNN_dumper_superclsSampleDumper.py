# Starts from alessandro's electrons step2, run TICLv5 with dumper and Mustache (no DNN), FEVTDEBUG for hgcal and electron studies
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step3_TICLv5_mustache nevts:1'),
...
process = customiseForTICLv5(process, True, enableSuperclusteringDNN=False) #True to also run the TICLDumper
...
process.schedule = cms.Schedule(process.raw2digi_step,process.reconstruction_step,process.recosim_step,
    ...
    process.prevalidation_step,process.prevalidation_step1,process.prevalidation_step2,process.prevalidation_step3,process.prevalidation_step4,process.prevalidation_step5,process.prevalidation_step6,process.prevalidation_step7,
    process.prevalidation_step8, process.validation_step,
