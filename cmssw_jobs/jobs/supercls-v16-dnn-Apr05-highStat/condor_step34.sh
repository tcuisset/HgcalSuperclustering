...
cat  <<EOF >>step3_TICLv5_DNN_dumperOnly.py
...
cmsRun -n 8 step3_TICLv5_DNN_dumperOnly.py
...
mv histo.root /grid_mnt/data_cms_upgrade/cuisset/supercls/alessandro_electrons/$VERSION/ticlDumper_$INDEX.root
