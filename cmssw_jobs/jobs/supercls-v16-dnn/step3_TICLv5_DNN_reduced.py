...
# Also runs DQM output for electron validation (electronMcSignalValidator+electronMcFakeValidator+electronMcSignalValidatorPt1000)
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    splitLevel = cms.untracked.int32(0) ######### no SPLITTING
)
