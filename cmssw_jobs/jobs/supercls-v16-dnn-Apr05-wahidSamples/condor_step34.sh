...
cat  <<EOF >>step3_TICLv5_DNN_dumperOnly_D99.py

process.source.fileNames = cms.untracked.vstring('file:$INPUT_FOLDER/$INPUT_FILE')
...
cmsRun -n 8 step3_TICLv5_DNN_dumperOnly_D99.py
...
mv histo.root /grid_mnt/data_cms_upgrade/cuisset/supercls/alessandro_electrons/$VERSION/ticlDumper_$INPUT_FILE
