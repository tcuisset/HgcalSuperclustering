...
Commands : 
python3 -m dnn_training.hyperparams_config.v5_onLoss --trainingLossType binary --device cuda:2
python3 -m dnn_training.hyperparams_config.v5_onLoss --trainingLossType continuousAssociationScore --device cuda:1
...
args.output = '/grid_mnt/data_cms_upgrade/cuisset/supercls/dnn_training/hyperparams-v4'
# args.device = "cuda:2"
args.studyName = f"hp-v5-{args.trainingLossType}"
args.nEpochs = 500
args.timeout = None
